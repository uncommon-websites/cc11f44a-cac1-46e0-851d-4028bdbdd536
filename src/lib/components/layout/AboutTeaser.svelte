...
<script lang="ts">
    ...
    name: "George Eliadis",
    role: "Founder & CEO",
    image: "/generated/image-a-confident-smiling-founder-standing-in-.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We built Probook because we lived the chaos of dispatch. Standing with dispatchers on the hard days—results are the only thing that matters."`}
    />
